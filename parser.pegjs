...
Int8
  = n:Expr { if(n<-127||n>256) throw new Error('Value overflow'); else return n; }

Int16
  = n:Expr { if(n<-32767||n>32768) throw new Error('Value overflow'); else return n; }

Offset8
  = "+" n:Expr { if(n>128) throw new Error('Value overflow'); else return n; } // TODO
  / "-" n:Expr { if(n>127) throw new Error('Value overflow'); else return -n; } // TODO
...
ExprAdd
  = head:ExprMul tail:("+" ExprMul)+ { var n = head; for(var i = 0; i < tail.length; i++) n += tail[i][1]; return n; }
  / head:ExprMul tail:("-" ExprMul)+ { var n = head; for(var i = 0; i < tail.length; i++) n -= tail[i][1]; return n; }
  / ExprMul
  
ExprMul
  = head:ExprPrimary tail:("*" ExprPrimary)+ { var n = head; for(var i = 0; i < tail.length; i++) n *= tail[i][1]; return n; }
  / head:ExprPrimary tail:("/" ExprPrimary)+ { var n = head; for(var i = 0; i < tail.length; i++) n /= tail[i][1]; return n; }
  / ExprPrimary
...
//
// insts (generated by util/opcodes.js)
//
Inst
  ...
  / "CALL"i _ nn:Int16                                                              		{ return [0xCD,nn&255,nn>>8]; } // CALL nn
  / "CALL"i _ "C"i _ "," _ nn:Int16                                                 		{ return [0xDC,nn&255,nn>>8]; } // CALL C,nn
  / "CALL"i _ "M"i _ "," _ nn:Int16                                                 		{ return [0xFC,nn&255,nn>>8]; } // CALL M,nn
  / "CALL"i _ "NC"i _ "," _ nn:Int16                                                		{ return [0xD4,nn&255,nn>>8]; } // CALL NC,nn
  / "CALL"i _ "NZ"i _ "," _ nn:Int16                                                		{ return [0xC4,nn&255,nn>>8]; } // CALL NZ,nn
  / "CALL"i _ "P"i _ "," _ nn:Int16                                                 		{ return [0xF4,nn&255,nn>>8]; } // CALL P,nn
  / "CALL"i _ "PE"i _ "," _ nn:Int16                                                		{ return [0xEC,nn&255,nn>>8]; } // CALL PE,nn
  / "CALL"i _ "PO"i _ "," _ nn:Int16                                                		{ return [0xE4,nn&255,nn>>8]; } // CALL PO,nn
  / "CALL"i _ "Z"i _ "," _ nn:Int16                                                 		{ return [0xCC,nn&255,nn>>8]; } // CALL Z,nn
  ...
  / "JP"i _ nn:Int16                                                                		{ return [0xC3,nn&255,nn>>8]; } // JP nn
  / "JP"i _ "(HL)"i                                                                 		{ return [0xE9]; } // JP (HL)
  / "JP"i _ "(IX)"i                                                                 		{ return [0xDD,0xE9]; } // JP (IX)
  / "JP"i _ "(IY)"i                                                                 		{ return [0xFD,0xE9]; } // JP (IY)
  / "JP"i _ "C"i _ "," _ nn:Int16                                                   		{ return [0xDA,nn&255,nn>>8]; } // JP C,nn
  / "JP"i _ "M"i _ "," _ nn:Int16                                                   		{ return [0xFA,nn&255,nn>>8]; } // JP M,nn
  / "JP"i _ "NC"i _ "," _ nn:Int16                                                  		{ return [0xD2,nn&255,nn>>8]; } // JP NC,nn
  / "JP"i _ "NZ"i _ "," _ nn:Int16                                                  		{ return [0xC2,nn&255,nn>>8]; } // JP NZ,nn
  / "JP"i _ "P"i _ "," _ nn:Int16                                                   		{ return [0xF2,nn&255,nn>>8]; } // JP P,nn
  / "JP"i _ "PE"i _ "," _ nn:Int16                                                  		{ return [0xEA,nn&255,nn>>8]; } // JP PE,nn
  / "JP"i _ "PO"i _ "," _ nn:Int16                                                  		{ return [0xE2,nn&255,nn>>8]; } // JP PO,nn
  / "JP"i _ "Z"i _ "," _ nn:Int16                                                   		{ return [0xCA,nn&255,nn>>8]; } // JP Z,nn
  ...
  / "LD"i _ "(" _ nn:Int16 _ ")" _ "," _ "A"i                                       		{ return [0x32,nn&255,nn>>8]; } // LD (nn),A
  / "LD"i _ "(" _ nn:Int16 _ ")" _ "," _ "BC"i                                      		{ return [0xED,0x43,nn&255,nn>>8]; } // LD (nn),BC
  / "LD"i _ "(" _ nn:Int16 _ ")" _ "," _ "DE"i                                      		{ return [0xED,0x53,nn&255,nn>>8]; } // LD (nn),DE
  / "LD"i _ "(" _ nn:Int16 _ ")" _ "," _ "HL"i                                      		{ return [0x22,nn&255,nn>>8]; } // LD (nn),HL
  / "LD"i _ "(" _ nn:Int16 _ ")" _ "," _ "IX"i                                      		{ return [0xDD,0x22,nn&255,nn>>8]; } // LD (nn),IX
  / "LD"i _ "(" _ nn:Int16 _ ")" _ "," _ "IY"i                                      		{ return [0xFD,0x22,nn&255,nn>>8]; } // LD (nn),IY
  / "LD"i _ "(" _ nn:Int16 _ ")" _ "," _ "SP"i                                      		{ return [0xED,0x73,nn&255,nn>>8]; } // LD (nn),SP
  ...
  / "LD"i _ "A"i _ "," _ "(" _ nn:Int16 _ ")"                                       		{ return [0x3A,nn&255,nn>>8]; } // LD A,(nn)
  ...
  / "LD"i _ "BC"i _ "," _ "(" _ nn:Int16 _ ")"                                      		{ return [0xED,0x4B,nn&255,nn>>8]; } // LD BC,(nn)
  / "LD"i _ "BC"i _ "," _ nn:Int16                                                  		{ return [0x01,nn&255,nn>>8]; } // LD BC,nn
  ...
  / "LD"i _ "DE"i _ "," _ "(" _ nn:Int16 _ ")"                                      		{ return [0xED,0x5B,nn&255,nn>>8]; } // LD DE,(nn)
  / "LD"i _ "DE"i _ "," _ nn:Int16                                                  		{ return [0x11,nn&255,nn>>8]; } // LD DE,nn
  ...
  / "LD"i _ "HL"i _ "," _ "(" _ nn:Int16 _ ")"                                      		{ return [0x2A,nn&255,nn>>8]; } // LD HL,(nn)
  / "LD"i _ "HL"i _ "," _ nn:Int16                                                  		{ return [0x21,nn&255,nn>>8]; } // LD HL,nn
  / "LD"i _ "I"i _ "," _ "A"i                                                       		{ return [0xED,0x47]; } // LD I,A
  / "LD"i _ "IX"i _ "," _ "(" _ nn:Int16 _ ")"                                      		{ return [0xDD,0x2A,nn&255,nn>>8]; } // LD IX,(nn)
  / "LD"i _ "IX"i _ "," _ nn:Int16                                                  		{ return [0xDD,0x21,nn&255,nn>>8]; } // LD IX,nn
  ...
  / "LD"i _ "IY"i _ "," _ "(" _ nn:Int16 _ ")"                                      		{ return [0xFD,0x2A,nn&255,nn>>8]; } // LD IY,(nn)
  / "LD"i _ "IY"i _ "," _ nn:Int16                                                  		{ return [0xFD,0x21,nn&255,nn>>8]; } // LD IY,nn
  ...
  / "LD"i _ "SP"i _ "," _ "(" _ nn:Int16 _ ")"                                      		{ return [0xED,0x7B,nn&255,nn>>8]; } // LD SP,(nn)
  ...
  / "LD"i _ "SP"i _ "," _ nn:Int16                                                  		{ return [0x31,nn&255,nn>>8]; } // LD SP,nn
