        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              result0 = parse_Inst();
              if (result0 !== null) {
                result0 = (function(offset, line, column, i) { return _.extend(i, {line:line}); })(pos0.offset, pos0.line, pos0.column, result0);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
                              ...
                              if (result0 === null) {
                                ...
                                if (result0 === null) {
                                  ...
                                  if (result0 === null) {
                                    ...
                                    if (result0 !== null) {
                                      result0 = (function(offset, line, column, n) { prevRepeats.push(repeat); repeat = {count:n, body:[]}; return {}; })(pos0.offset, pos0.line, pos0.column, result0[2]);
                                    }
                                    if (result0 === null) {
                                      pos = clone(pos0);
                                    }
                                    if (result0 === null) {
                                      ...
                                      if (result0 !== null) {
                                        result0 = (function(offset, line, column) { var r = repeat; repeat = prevRepeats.pop(); return {repeat:r}; })(pos0.offset, pos0.line, pos0.column);
                                      }
                                      if (result0 === null) {
                                        pos = clone(pos0);
                                      }
            ...
            if (result0 === null) {
              ...
              if (result0 === null) {
                ...
                if (result0 === null) {
                  ...
                  if (result0 !== null) {
                    result0 = (function(offset, line, column) { return {id:'__here__'}; })(pos0.offset, pos0.line, pos0.column);
                  }
                  if (result0 === null) {
                    pos = clone(pos0);
                  }
