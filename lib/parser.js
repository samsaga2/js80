  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_Line() {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                if (input.substr(pos.offset, 3).toLowerCase() === "equ") {
                  result4 = input.substr(pos.offset, 3);
                  advance(pos, 3);
                } else {
                  result4 = null;
                  if (reportFailures === 0) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, l, e) { return ast.equ(l, e, line); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[6]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
