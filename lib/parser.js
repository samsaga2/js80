  ...
  var result = {
    ...
    parse: function(input, startRule) {
                ...
                if (result0 === null) {
                  ...
                  if (result0 === null) {
                    ...
                    if (result0 === null) {
                      ...
                      if (result0 !== null) {
                        result0 = (function(offset, line, column) { return ast.endModule(i); })(pos0.offset, pos0.line, pos0.column);
                      }
                      if (result0 === null) {
                        pos = clone(pos0);
                      }
      ...
      function parse_PageArg() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, s, e) { return ast.macro.range(s, e); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_MacroArg() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return ast.macro.rest(); })(pos0.offset, pos0.line, pos0.column);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, i, e) { return ast.macro.arg(i, e); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            result0 = parse_Identifier();
            if (result0 !== null) {
              result0 = (function(offset, line, column, i) { return ast.macro.arg(i); })(pos0.offset, pos0.line, pos0.column, result0);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
      ...
      function parse_ExprLogic() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, left, right) { return ast.expr.binaryOperator("^", left, right); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
