...
module.exports = {
    ...
    assign: function (labelName, valueExpr, lineIndex) {
        return line({assign: {label: labelName, value: valueExpr}, line: lineIndex});
    },
    ...
    org: function (valueExpr) {
        return {org: valueExpr};
    },
