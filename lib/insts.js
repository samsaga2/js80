...
commands.map = function (map, js80) {
    js80.environment.setGlobal('__map__', evalExpr(map, js80.environment));
};
...
commands.struct = function (struct, js80) {
    ...
    js80.environment.setGlobal('__map__', savedMap);
    env.pop();
};
...
commands.equ = function (equ, js80) {
    var value = evalExpr(equ.value, js80.environment);
    js80.defineLabel(equ.label, value);
};

commands.assign = function (assign, js80) {
    var value = evalExpr(assign.value, js80.environment);
    js80.environment.setGlobal(assign.label, value);
};

commands.module = function (module, js80) {
    js80.environment.set('__module__', module);
};

commands.endmodule = function (endmodule, js80) {
    js80.environment.set('__module__', '');
};
...
commands.rotate = function (rotate, js80) {
    ...
    js80.environment.set('__arguments__', args);
};
...
module.exports.write = function (js80, code) {
    ...
    js80.environment.setGlobal('$', js80.image.here());

    if (code.line) {
	var macro = js80.environment.get('__macro__');
	if(macro != '') {
            js80.environment.set('__macroLineIndex__', code.line);
	} else {
            js80.environment.set('__lineIndex__', code.line);
	}
    }
